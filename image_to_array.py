...
if __name__ == '__main__':
    ...
    labels = pd.read_csv("C:/Users/behl/Desktop/jupyter notebook/minor/sample_labels.csv")

    print("Writing Train Array")
    X_train = convert_images_to_arrays('C:/Users/behl/Desktop/jupyter notebook/minor/resized-512/', labels)

    print(X_train.shape)

    print("Saving Train Array")
    save_to_array('C:/Users/behl/Desktop/jupyter notebook/minor/X_sample.npy', X_train)
