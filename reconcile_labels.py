...
if __name__ == '__main__':
    data = pd.read_csv("C:/Users/behl/Desktop/jupyter notebook/minor/Data_Entry_2017.csv")
    sample = os.listdir('C:/Users/behl/Desktop/jupyter notebook/minor/resized-512/')
    ...
    print("Writing CSV")
    sample.to_csv('C:/Users/behl/Desktop/jupyter notebook/minor/sample_labels.csv', index=False, header=True)
